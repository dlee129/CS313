...
public class Project3{
    ...
    public static void main(String[] args) {
    	...
    	try{
			BufferedReader sourceFile = new BufferedReader(new InputStreamReader(new FileInputStream("project3.txt")));
			String line = sourceFile.readLine();
			System.out.println("The original infix notation is: "+line);
            InfixPostfixConverter convert = new InfixPostfixConverter(line);
            System.out.println("The equivalent postfix notation is: "+convert.infixToPostfix());
            String PostExpression = convert.infixToPostfix();
            ArithmeticExpressionTree eval = new ArithmeticExpressionTree(PostExpression);
            eval.ArithmeticTreeEvaluation();
        	System.out.println("The value of the entire Arithmetic Expression is : " );
